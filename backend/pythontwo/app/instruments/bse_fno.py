...
class BSEFNOFeed:
    def __init__(self):
        ...
        self.access_token = os.getenv('DHAN_ACCESS_TOKEN', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJkaGFuIiwicGFydG5lcklkIjoiIiwiZXhwIjoxNzUxNjE0MDI0LCJ0b2tlbkNvbnN1bWVyVHlwZSI6IlNFTEYiLCJ3ZWJob29rVXJsIjoiIiwiZGhhbkNsaWVudElkIjoiMTEwNjcyNzk1MyJ9.jl54WJLmlWvv3kC_mBSpAQE1z2snqqhyaEIiIjsKUNECtJdHhK-T7RxieDtfjxTE62rwU6LrehGkbeOGBPlshQ')
        self.mongo_uri = os.getenv('MONGO_URI', 'mongodb://localhost:27017')
        self.mongo_client = MongoClient(self.mongo_uri)
        self.db = self.mongo_client['Upholic']
        self.collection = self.db['bse_fno']

        self.version = "v2"
        self.data = None

    def fetch_fno_instruments(self):
        """Fetch BSE F&O instruments from Dhan master CSV."""
    ...
    def prepare_subscriptions(self, df):
        ...
        if df is None or df.empty:
            ...
            return [
                (marketfeed.BSE_FNO, "57131", marketfeed.Full),  # NIFTY FUT
                (marketfeed.BSE_FNO, "57132", marketfeed.Full)   # BANKNIFTY FUT
            ]
